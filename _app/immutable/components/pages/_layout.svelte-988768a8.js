...
function create_fragment(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      a1 = claim_element(div12_nodes, "A", { href: true });
      ...
      a2 = claim_element(div14_nodes, "A", { href: true });
      ...
      t11 = claim_text(div15_nodes, "💛 Organized by ");
      a3 = claim_element(div15_nodes, "A", { href: true, class: true });
      var a3_nodes = children(a3);
      t12 = claim_text(a3_nodes, "ETHBrno");
      a3_nodes.forEach(detach);
      t13 = claim_text(div15_nodes, " team");
    ...
    h() {
      ...
      attr(div14, "class", "inline-block");
      attr(a3, "href", "https://ethbrno.cz");
      attr(a3, "class", "underline hover:no-underline");
      attr(div15, "class", "mt-4");
      attr(div16, "class", "text-right");
      attr(div17, "class", "flex items-center");
      attr(div18, "class", "middle-pane-big pt-6 mx-auto");
      attr(div19, "class", "pb-16 bg-black");
      attr(div20, "class", "relative w-full min-h-screen");
    },
    m(target, anchor) {
