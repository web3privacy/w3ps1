...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      div9 = element("div");
      p0 = element("p");
      t8 = text("Diving into the culture of the Web3 privacy industry");
      t9 = space();
      p1 = element("p");
      a1 = element("a");
      t10 = text("Prague Blockchain Week 2023");
      t11 = space();
      if (default_slot)
        default_slot.c();
      t12 = space();
    ...
    l(nodes) {
      ...
      t8 = claim_text(p0_nodes, "Diving into the culture of the Web3 privacy industry");
